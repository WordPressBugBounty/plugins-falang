...
* 1.4.2 (2026/05/07)
* add filter menu item by language (Pro)
* fix warning display on hreflang (post not set)
* change flush to soft on post update.

* 1.4.1 (2026/03/18)
* display hreflang only for cpt not set to a specific langauge
* fix dynamic warning
